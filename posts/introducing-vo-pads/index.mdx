...
tags: ['react', 'vo-pads']
description: 'Building a video player that feels like an Akai MPC'
heroImage: './img/vopads-screen.jpg'
...
import imageScreen from './img/vopads-screen.jpg';
...
<Youtube id="R0DIJ43FIp0" title="VO Pads - Assembling Get Away" />
...
<ImageModal src={imageScreen} alt="Strips of digits, all in a row" width={640} height={300} fit="cover" />
