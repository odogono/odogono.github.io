...
<div class="image-row flex flex-row gap-4 m-32" style="margin: 32px 0;">
<ImageModal src={imageA} alt="Tile A" width={150} height={160} fit="" />
<ImageModal src={imageB} alt="Tile B" width={150} height={325} fit="cover" />
</div>
