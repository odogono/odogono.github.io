...
pubDate: 2024-10-07T18:40:31+01:00
isDraft: false
isPost: true
...
import imageFinal from './img/final.jpg';
import imageDigitStrips from './img/digitstrips.png';

<ImageModal src={imageFinal} alt="Strips of digits, all in a row" width={640} height={400} />
...
<ImageModal src={imageDigitStrips} alt="Strips of digits, all in a row" width={640} height={200} fit="cover" />
