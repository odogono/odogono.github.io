...
pubDate: 2024-11-25T12:37:00+01:00
isDraft: false
isPost: true
weather: '10°C Windy'
location: '50.79°N, 3.65°W'
tags: ['react-native', 'skia', 'react', 'reanimated']

description: 'A dive into creating animated gradient trails in React Native Skia'
heroImage: './img/path.boids.png'
---

import ImageModal from '@components/image-modal.astro';
import Youtube from '@components/youtube.astro';
import imageAppleMaps from './img/apple.maps.path.anim.jpg';
import imagePathDivisions4 from './img/path.divisions.4.png';
import imagePathDivisions10 from './img/path.divisions.10.png';
import imagePathDivisions30 from './img/path.divisions.30.png';
import imagePathTrail from './img/path.trail.png';
import imagePathBoids from './img/path.boids.png';


<Youtube id="24fjKn87tmk" title="React Native Skia Gradient Paths Demo" />
...
<ImageModal src={imageAppleMaps} alt="Apple Maps Introducing Custom Routes" width={317} height={350} fit="cover" />
</div>
...
<ImageModal src={imagePathDivisions4} alt="path made up of three sections" width={317} height={350} fit="cover" />
<ImageModal src={imagePathDivisions10} alt="path made up of ten sections" width={317} height={350} fit="cover" />
<ImageModal src={imagePathDivisions30} alt="path made up of thirty sections" width={317} height={350} fit="cover" />
</div>
...
<div class="flex justify-center my-8 gap-4">
<ImageModal src={imagePathTrail} alt="Path with gradient trail. And a bit of glow" width={317} height={350} fit="cover" />
</div>
...
<div class="flex justify-center my-8 gap-4">
<ImageModal src={imagePathBoids} alt="Trails flocking around" width={317} height={350} fit="cover" />
</div>
